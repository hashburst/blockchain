...
The Go version will include additional P2P networking and validation, enabling decentralized nodes and interactions. Nodes can communicate over TCP or over TEP, sending encrypted transactions and blocks.
