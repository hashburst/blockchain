...
func TestHVMNetworkNodeClassRolesAndTEPEligibility(t *testing.T) {
	base := NodeRecordV2{
		NodeRecord:      NodeRecord{NodeID: "hvm-network-hpc", PeerID: "12D3KooWHVMNetwork", ChainID: 1337, TEPPubkey: "0123456789abcdef"},
