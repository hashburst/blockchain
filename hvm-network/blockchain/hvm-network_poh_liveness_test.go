...
func TestHVMNetworkDefaultPoHTicksUnchanged(t *testing.T) {
...
func TestHVMNetworkProductionPoHVectorsUnchanged(t *testing.T) {
	vectors := []struct {
		prev int64
		want int64
	}{
...
func TestHVMNetworkIsolatedPoHTicksAreConfigBound(t *testing.T) {
	cfg := DefaultProtocolV2Config()
...
func TestHVMNetworkPoHTickBoundsFailClosed(t *testing.T) {
