...
func TestPhase3ERepeatedCertifiedReproposal(t *testing.T) {
...
func TestPhase3EResumeFourValidatorsAfterLostMessages(t *testing.T) {
	s := setupPhase3DChains(t)
...
func TestPhase3EResumePreservesSafetyState(t *testing.T) {
	s := setupPhase3DChains(t)
...
func TestPhase3EResumeSigningFailureStopsReactor(t *testing.T) {
	s := setupPhase3DChains(t)
